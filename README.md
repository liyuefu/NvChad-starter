# 1.this is from NcChad-starter, just change severl lines , it can support python, bash, clang lsp. if you want to support clang debuging, autoformat, please use the fork from version 2.0, instead of  2.5
